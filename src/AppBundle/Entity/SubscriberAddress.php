 ...
 * SubscriberAddress
 *
 * @ORM\Table(name="05_SubscriberAddress", uniqueConstraints={@ORM\UniqueConstraint(name="subsc_address_pkey", columns={"id"})} )
...
class SubscriberAddress
{
     ...
     * @var int
     *
     * @ORM\Column(name="verifiedid", type="smallint")
     */
    private $verifiedid;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="datemodified", type="time", nullable=true)
     */
